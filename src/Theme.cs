...
namespace IgnoreFiles
{
    public static class Theme
    {
        private static ResourceDictionary BuildThemeResources()
        {
            ...
            ResourceDictionary localThemingContainer = (ResourceDictionary)Application.LoadComponent(new Uri("IgnoreFiles;component/Controls/Shared.xaml", UriKind.Relative));
